package com.jdjtlibrary.animfra;
...
/**
 * 滑动fragment自定动画,附带文件:animator整个文件,integers.xml(values下)
 */
...
public class FragmentTransactionExtended implements FragmentManager.OnBackStackChangedListener {
    ...
    public static final int SLIDING = 0;  //暂停使用
    ...
    public static final int SCALEX = 11;
